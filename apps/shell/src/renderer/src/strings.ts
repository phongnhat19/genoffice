...
export const strings = {
  zh: {
    ...
    account: '账号',
    login: '登录',
    loginORIO: '登录 ORIO 账号',
    loggedIn: '已登录',
    loggedInORIO: '已登录 ORIO',
    ...
    loginCopyUrl: '复制登录链接',
    loginCopied: '已复制',
    loginNetworkError: '无法连接 ORIO,请检查网络或代理设置',
  ...
  en: {
    ...
    untitled: 'Untitled',
    noContent: '(empty)',
    accountORIO: 'ORIO Account',
    account: 'Account',
    login: 'Sign in',
    loginORIO: 'Sign in with ORIO',
    loggedIn: 'Signed in',
    loggedInORIO: 'Signed in to ORIO',
    ...
    loginCopied: 'Copied',
    loginNetworkError: 'Cannot reach ORIO — check your network or proxy settings',
    ...
    onbBody2:
      'ORIO is still in alpha. Join the group chat on ORIO Community to share feedback and help shape what comes next.',
    onbCredits: 'Active contributors get **1,000+ ORIO credits**',
    onbJoinCommunity: 'Join ORIO Community',
    onbSkip: 'Skip',
    onbNext: 'Next',
  ...
  ja: {
    ...
    noContent: '（内容なし）',
    // Account
    accountORIO: 'ORIO アカウント',
    account: 'アカウント',
    login: 'サインイン',
    loginORIO: 'ORIO アカウントでサインイン',
    loggedIn: 'サインイン済み',
    loggedInORIO: 'ORIO にサインイン済み',
    waitingLogin:
    ...
    newTab: '新しいタブ',
    // First-run onboarding
    onbTitle1: 'ORIO へようこそ',
    onbSubtitle1: '初のオープンソース AI ネイティブ Office スイート',
    onbBody1:
      '文書の作成、表計算、プレゼン作成、PDF のレビュー。あらゆるステップに AI が組み込まれています。',
    onbTitle2: 'これはまだ始まりにすぎません',
    onbBody2:
      'ORIO はまだアルファ版です。ORIO Community のグループチャットに参加して、フィードバックを共有し、今後の開発を一緒に形作りましょう。',
    onbCredits: 'アクティブな貢献者への特典 **1,000+ ORIO クレジット**',
    onbJoinCommunity: 'ORIO Community に参加',
    onbSkip: 'スキップ',
    onbNext: '次へ',
    onbStart: 'はじめる',
    ...
    onbNote3: 'AI 機能は ORIO クレジットを消費する場合があります。',
    onbBack: '戻る',
  },
  ko: {
    // Sidebar navigation
    ...
    account: '계정',
    login: '로그인',
    loginORIO: 'ORIO 계정으로 로그인',
    loggedIn: '로그인됨',
    loggedInORIO: 'ORIO에 로그인됨',
    ...
    loginCopied: '복사됨',
    loginNetworkError: 'ORIO에 연결할 수 없습니다. 네트워크 또는 프록시 설정을 확인하세요',
    ...
    newTab: '새 탭',
    // First-run onboarding
    onbTitle1: 'ORIO에 오신 것을 환영합니다',
    onbSubtitle1: '최초의 오픈소스 AI 네이티브 오피스 제품군',
    onbBody1:
      '문서 작성, 스프레드시트 제작, 프레젠테이션 생성, PDF 검토. 모든 단계에 AI가 녹아 있습니다.',
    onbTitle2: '이제 시작일 뿐입니다',
    onbBody2:
      'ORIO는 아직 알파 단계입니다. ORIO Community 그룹 채팅에 참여해 피드백을 공유하고 앞으로의 방향을 함께 만들어 가세요.',
    onbCredits: '활발한 기여자를 위한 혜택 **1,000+ ORIO 크레딧**',
    onbJoinCommunity: 'ORIO Community 참여하기',
    onbSkip: '건너뛰기',
    onbNext: '다음',
    onbStart: '시작하기',
    ...
    onbNote3: 'AI 기능은 ORIO 크레딧을 소모할 수 있습니다.',
    onbBack: '이전',
  },
  fr: {
    // Sidebar navigation
    ...
    noContent: '(vide)',
    // Account
    accountORIO: 'Compte ORIO',
    account: 'Compte',
    login: 'Se connecter',
    loginORIO: 'Se connecter avec ORIO',
    loggedIn: 'Connecté',
    loggedInORIO: 'Connecté à ORIO',
    waitingLogin:
    ...
    loginCopied: 'Copié',
    loginNetworkError:
      'Impossible de joindre ORIO — vérifiez votre réseau ou vos paramètres de proxy',
    ...
    onbBody2:
      'ORIO est encore en alpha. Rejoignez la discussion de groupe sur ORIO Community pour partager vos retours et façonner la suite.',
    onbCredits: 'Les contributeurs actifs reçoivent **1 000+ crédits ORIO**',
    onbJoinCommunity: 'Rejoindre ORIO Community',
    onbSkip: 'Passer',
    onbNext: 'Suivant',
    onbStart: 'Commencer',
    ...
    onbNote3: 'Les fonctions IA peuvent consommer des crédits ORIO.',
    onbBack: 'Retour',
  },
  de: {
    // Sidebar navigation
    ...
    noContent: '(leer)',
    // Account
    accountORIO: 'ORIO-Konto',
    account: 'Konto',
    login: 'Anmelden',
    loginORIO: 'Mit ORIO anmelden',
    loggedIn: 'Angemeldet',
    loggedInORIO: 'Bei ORIO angemeldet',
    waitingLogin:
    ...
    onbBody2:
      'ORIO ist noch in der Alpha-Phase. Treten Sie dem Gruppenchat auf ORIO Community bei, um Feedback zu teilen und die Zukunft mitzugestalten.',
    onbCredits: 'Aktive Mitwirkende erhalten **1.000+ ORIO-Guthaben**',
    onbJoinCommunity: 'ORIO Community beitreten',
    ...
    onbNote3: 'KI-Funktionen können ORIO-Credits verbrauchen.',
    onbBack: 'Zurück',
  },
  es: {
    // Sidebar navigation
    ...
    noContent: '(vacío)',
    // Account
    accountORIO: 'Cuenta de ORIO',
    account: 'Cuenta',
    login: 'Iniciar sesión',
    loginORIO: 'Iniciar sesión con ORIO',
    loggedIn: 'Sesión iniciada',
    loggedInORIO: 'Sesión iniciada en ORIO',
    waitingLogin:
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'No se puede conectar con ORIO — compruebe su red o la configuración del proxy',
    ...
    onbBody2:
      'ORIO aún está en alfa. Únete al chat grupal en ORIO Community para compartir comentarios y ayudar a dar forma a lo que viene.',
    onbCredits: 'Los colaboradores activos reciben **1.000+ créditos de ORIO**',
    onbJoinCommunity: 'Unirse a ORIO Community',
    onbSkip: 'Omitir',
    onbNext: 'Siguiente',
    onbStart: 'Empezar',
    ...
    onbNote3: 'Las funciones de IA pueden consumir créditos de ORIO.',
    onbBack: 'Atrás',
  },
  th: {
    // Sidebar navigation
    ...
    // Account
    accountORIO: 'บัญชี ORIO',
    account: 'บัญชี',
    login: 'ลงชื่อเข้าใช้',
    loginORIO: 'ลงชื่อเข้าใช้ด้วย ORIO',
    loggedIn: 'ลงชื่อเข้าใช้แล้ว',
    loggedInORIO: 'ลงชื่อเข้าใช้ ORIO แล้ว',
    ...
    loginNetworkError: 'ไม่สามารถเชื่อมต่อ ORIO ได้ โปรดตรวจสอบเครือข่ายหรือการตั้งค่าพร็อกซี',
    ...
    newTab: 'แท็บใหม่',
    // First-run onboarding
    onbTitle1: 'ยินดีต้อนรับสู่ ORIO',
    ...
    onbBody2:
      'ORIO ยังอยู่ในช่วงอัลฟ่า เข้าร่วมแชทกลุ่มบน ORIO Community เพื่อแบ่งปันความคิดเห็นและร่วมกำหนดทิศทางต่อไป',
    onbCredits: 'ผู้มีส่วนร่วมอย่างต่อเนื่องจะได้รับ **เครดิต ORIO กว่า 1,000**',
    onbJoinCommunity: 'เข้าร่วม ORIO Community',
    onbSkip: 'ข้าม',
    onbNext: 'ถัดไป',
    ...
    onbNote3: 'ฟีเจอร์ AI อาจใช้เครดิต ORIO',
    onbBack: 'ย้อนกลับ',
  },
  id: {
    // Sidebar navigation
    ...
    noContent: '(kosong)',
    // Account
    accountORIO: 'Akun ORIO',
    account: 'Akun',
    login: 'Masuk',
    loginORIO: 'Masuk dengan ORIO',
    loggedIn: 'Sudah masuk',
    loggedInORIO: 'Sudah masuk ke ORIO',
    ...
    loginCopied: 'Disalin',
    loginNetworkError:
      'Tidak dapat terhubung ke ORIO — periksa jaringan atau pengaturan proxy Anda',
    ...
    newTab: 'Tab baru',
    // First-run onboarding
    onbTitle1: 'Selamat datang di ORIO',
    ...
    onbBody2:
      'ORIO masih dalam tahap alpha. Gabung obrolan grup di ORIO Community untuk berbagi masukan dan ikut menentukan arah ke depan.',
    onbCredits: 'Kontributor aktif mendapat **1.000+ kredit ORIO**',
    onbJoinCommunity: 'Gabung ORIO Community',
    onbSkip: 'Lewati',
    onbNext: 'Berikutnya',
    onbStart: 'Mulai',
    ...
    onbNote3: 'Fitur AI dapat menggunakan kredit ORIO.',
    onbBack: 'Kembali',
  },
  ru: {
    // Sidebar navigation
    ...
    noContent: '(пусто)',
    // Account
    accountORIO: 'Учётная запись ORIO',
    account: 'Учётная запись',
    login: 'Войти',
    loginORIO: 'Войти через ORIO',
    loggedIn: 'Вход выполнен',
    loggedInORIO: 'Выполнен вход в ORIO',
    ...
    loginNetworkError: 'Не удаётся подключиться к ORIO — проверьте сеть или настройки прокси',
    ...
    // First-run onboarding
    onbTitle1: 'Добро пожаловать в ORIO',
    ...
    onbBody2:
      'ORIO пока в альфа-версии. Присоединяйтесь к групповому чату в ORIO Community, чтобы делиться отзывами и влиять на дальнейшее развитие.',
    onbCredits: 'Активные участники получают **1000+ кредитов ORIO**',
    onbJoinCommunity: 'Присоединиться к ORIO Community',
    onbSkip: 'Пропустить',
    onbNext: 'Далее',
    onbStart: 'Начать',
    ...
    onbNote3: 'Функции ИИ могут расходовать кредиты ORIO.',
    onbBack: 'Назад',
  },
  ar: {
    // Sidebar navigation
    ...
    noContent: '(فارغ)',
    // Account
    accountORIO: 'حساب ORIO',
    account: 'الحساب',
    login: 'تسجيل الدخول',
    loginORIO: 'تسجيل الدخول باستخدام ORIO',
    loggedIn: 'تم تسجيل الدخول',
    loggedInORIO: 'تم تسجيل الدخول إلى ORIO',
    ...
    loginNetworkError: 'تعذّر الاتصال بـ ORIO — تحقق من الشبكة أو إعدادات الوكيل',
    ...
    onbBody2:
      'لا يزال ORIO في مرحلة ألفا. انضم إلى الدردشة الجماعية على ORIO Community لمشاركة ملاحظاتك والمساهمة في تشكيل المستقبل.',
    onbCredits: 'يحصل المساهمون النشطون على **+1,000 من أرصدة ORIO**',
    onbJoinCommunity: 'الانضمام إلى ORIO Community',
    onbSkip: 'تخطي',
    onbNext: 'التالي',
    onbStart: 'ابدأ الآن',
    ...
    onbNote3: 'قد تستهلك ميزات الذكاء الاصطناعي أرصدة ORIO.',
    onbBack: 'رجوع',
  },
  pt: {
    navRecent: 'Recentes',
    ...
    untitled: 'Sem título',
    noContent: '(vazio)',
    accountORIO: 'Conta ORIO',
    account: 'Conta',
    login: 'Entrar',
    loginORIO: 'Entrar com a ORIO',
    loggedIn: 'Conectado',
    loggedInORIO: 'Conectado à ORIO',
    ...
    loginCopied: 'Copiado',
    loginNetworkError:
      'Não foi possível conectar ao ORIO — verifique sua rede ou as configurações de proxy',
    ...
    onbBody2:
      'O ORIO ainda está em alfa. Entre no chat em grupo no ORIO Community para compartilhar feedback e ajudar a moldar o que vem a seguir.',
    onbCredits: 'Contribuidores ativos recebem **1.000+ créditos ORIO**',
    onbJoinCommunity: 'Entrar no ORIO Community',
    onbSkip: 'Pular',
    onbNext: 'Avançar',
    onbStart: 'Começar',
    onbStepAria: 'Página {n} de {total}',
    ...
    onbNote3: 'Os recursos de IA podem consumir créditos ORIO.',
    onbBack: 'Voltar',
  },
  it: {
    navRecent: 'Recenti',
    ...
    noContent: '(vuoto)',
    accountORIO: 'Account ORIO',
    account: 'Account',
    login: 'Accedi',
    loginORIO: 'Accedi con ORIO',
    loggedIn: 'Accesso effettuato',
    loggedInORIO: 'Accesso effettuato a ORIO',
    ...
    loginCopied: 'Copiato',
    loginNetworkError:
      'Impossibile raggiungere ORIO — controlla la rete o le impostazioni del proxy',
    ...
    onbBody2:
      'ORIO è ancora in alpha. Unisciti alla chat di gruppo su ORIO Community per condividere feedback e contribuire a plasmare il futuro.',
    onbCredits: 'I collaboratori attivi ricevono **1.000+ crediti ORIO**',
    onbJoinCommunity: 'Unisciti a ORIO Community',
    onbSkip: 'Salta',
    onbNext: 'Avanti',
    onbStart: 'Inizia',
    ...
    onbNote3: 'Le funzioni IA possono consumare crediti ORIO.',
    onbBack: 'Indietro',
  },
  pl: {
    navRecent: 'Ostatnie',
    ...
    untitled: 'Bez tytułu',
    noContent: '(pusto)',
    accountORIO: 'Konto ORIO',
    account: 'Konto',
    login: 'Zaloguj się',
    loginORIO: 'Zaloguj się przez ORIO',
    loggedIn: 'Zalogowano',
    loggedInORIO: 'Zalogowano do ORIO',
    waitingLogin:
    ...
    loginNetworkError: 'Nie można połączyć się z ORIO — sprawdź sieć lub ustawienia proxy',
    ...
    onbBody2:
      'ORIO jest wciąż w fazie alfa. Dołącz do czatu grupowego na ORIO Community, aby dzielić się opiniami i współtworzyć jego przyszłość.',
    onbCredits: 'Aktywni współtwórcy otrzymują **1000+ kredytów ORIO**',
    onbJoinCommunity: 'Dołącz do ORIO Community',
    onbSkip: 'Pomiń',
    onbNext: 'Dalej',
    onbStart: 'Rozpocznij',
    ...
    onbNote3: 'Funkcje AI mogą zużywać kredyty ORIO.',
    onbBack: 'Wstecz',
  },
  nl: {
    navRecent: 'Recent',
    ...
    account: 'Account',
    login: 'Inloggen',
    loginORIO: 'Inloggen met ORIO',
    loggedIn: 'Ingelogd',
    loggedInORIO: 'Ingelogd bij ORIO',
    ...
    loginNetworkError: 'Kan ORIO niet bereiken — controleer uw netwerk of proxyinstellingen',
    ...
    onbBody2:
      'ORIO is nog in alfa. Doe mee aan de groepschat op ORIO Community om feedback te delen en mee te bepalen wat er komt.',
    onbCredits: 'Actieve bijdragers krijgen **1.000+ ORIO-credits**',
    onbJoinCommunity: 'Word lid van ORIO Community',
    onbSkip: 'Overslaan',
    onbNext: 'Volgende',
    ...
    onbNote3: 'AI-functies kunnen ORIO-credits verbruiken.',
    onbBack: 'Terug',
  },
  ms: {
    navRecent: 'Terkini',
    ...
    noContent: '(kosong)',
    accountORIO: 'Akaun ORIO',
    account: 'Akaun',
    login: 'Log masuk',
    loginORIO: 'Log masuk dengan ORIO',
    loggedIn: 'Telah log masuk',
    loggedInORIO: 'Telah log masuk ke ORIO',
    ...
    newTab: 'Tab baharu',
    // First-run onboarding
    onbTitle1: 'Selamat datang ke ORIO',
    ...
    onbTitle2: 'Ini baru permulaan',
    onbBody2:
      'ORIO masih dalam peringkat alfa. Sertai sembang kumpulan di ORIO Community untuk berkongsi maklum balas dan membentuk masa depannya.',
    onbCredits: 'Penyumbang aktif menerima **1,000+ kredit ORIO**',
    onbJoinCommunity: 'Sertai ORIO Community',
    onbSkip: 'Langkau',
    onbNext: 'Seterusnya',
    onbStart: 'Mula',
    ...
    onbNote3: 'Ciri AI mungkin menggunakan kredit ORIO.',
    onbBack: 'Kembali',
  },
  he: {
    navRecent: 'אחרונים',
    ...
    untitled: 'ללא שם',
    noContent: '(ריק)',
    accountORIO: 'חשבון ORIO',
    account: 'חשבון',
    login: 'התחברות',
    loginORIO: 'התחברות עם ORIO',
    loggedIn: 'מחובר',
    loggedInORIO: 'מחובר ל-ORIO',
    ...
    loginCopied: 'הועתק',
    loginNetworkError: 'לא ניתן להתחבר ל-ORIO — בדקו את הרשת או את הגדרות ה-proxy',
    ...
    onbBody2:
      'ORIO עדיין בגרסת אלפא. הצטרפו לצ׳אט הקבוצתי ב-ORIO Community כדי לשתף משוב ולעזור לעצב את ההמשך.',
    onbCredits: 'תורמים פעילים מקבלים **1,000+ נקודות ORIO**',
    onbJoinCommunity: 'הצטרפו ל-ORIO Community',
    onbSkip: 'דילוג',
    onbNext: 'הבא',
    onbStart: 'להתחיל',
    ...
    onbNote3: 'תכונות AI עשויות לצרוך קרדיטים של ORIO.',
    onbBack: 'חזרה',
  },
  hi: {
    navRecent: 'हाल के',
    ...
    noContent: '(खाली)',
    accountORIO: 'ORIO खाता',
    account: 'खाता',
    login: 'साइन इन करें',
    loginORIO: 'ORIO से साइन इन करें',
    loggedIn: 'साइन इन हो गया',
    loggedInORIO: 'ORIO में साइन इन है',
    waitingLogin:
    ...
    loginNetworkError: 'ORIO से कनेक्ट नहीं हो सका — नेटवर्क या प्रॉक्सी सेटिंग जांचें',
    ...
    newTab: 'नया टैब',
    // First-run onboarding
    onbTitle1: 'ORIO में आपका स्वागत है',
    ...
    onbBody2:
      'ORIO अभी अल्फ़ा में है। ORIO Community पर ग्रुप चैट से जुड़ें, फ़ीडबैक साझा करें और आगे की दिशा तय करने में मदद करें।',
    onbCredits: 'सक्रिय योगदानकर्ताओं के लिए **1,000+ ORIO क्रेडिट**',
    onbJoinCommunity: 'ORIO Community से जुड़ें',
    onbSkip: 'छोड़ें',
    onbNext: 'आगे',
    onbStart: 'शुरू करें',
    ...
    onbNote3: 'AI सुविधाएँ ORIO क्रेडिट खर्च कर सकती हैं।',
    onbBack: 'वापस',
  },
  'zh-TW': {
    navRecent: '最近',
    ...
    account: '帳號',
    login: '登入',
    loginORIO: '登入 ORIO 帳號',
    loggedIn: '已登入',
    loggedInORIO: '已登入 ORIO',
    ...
    loginCopyUrl: '複製登入連結',
    loginCopied: '已複製',
    loginNetworkError: '無法連線至 ORIO，請檢查網路或代理設定',
