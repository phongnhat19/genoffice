...
export const strings = {
  zh: {
    ...
    projectFolder: '项目文件夹',
    selectProjectFolder: '选择文件夹',
    changeProjectFolder: '更改文件夹',
    projectFolderRequired: '请选择项目文件夹以继续。',
  ...
  en: {
    ...
    selectProjectFolder: 'Select folder',
    changeProjectFolder: 'Change folder',
    projectFolderRequired: 'Select a project folder to continue.',
  ...
  ja: {
    ...
    selectProjectFolder: 'フォルダーを選択',
    changeProjectFolder: 'フォルダーを変更',
    projectFolderRequired: '続行するにはプロジェクトフォルダーを選択してください。',
    createProjectFailed: 'プロジェクトを作成できませんでした。',
  ...
  ko: {
    ...
    selectProjectFolder: '폴더 선택',
    changeProjectFolder: '폴더 변경',
    projectFolderRequired: '계속하려면 프로젝트 폴더를 선택하세요.',
    createProjectFailed: '프로젝트를 만들 수 없습니다.',
  ...
  fr: {
    ...
    selectProjectFolder: 'Choisir un dossier',
    changeProjectFolder: 'Modifier le dossier',
    projectFolderRequired: 'Choisissez un dossier de projet pour continuer.',
    createProjectFailed: 'Impossible de créer le projet.',
  ...
  de: {
    ...
    selectProjectFolder: 'Ordner auswählen',
    changeProjectFolder: 'Ordner ändern',
    projectFolderRequired: 'Wählen Sie einen Projektordner aus, um fortzufahren.',
  ...
  es: {
    ...
    selectProjectFolder: 'Seleccionar carpeta',
    changeProjectFolder: 'Cambiar carpeta',
    projectFolderRequired: 'Seleccione una carpeta de proyecto para continuar.',
  ...
  th: {
    ...
    createProjectTitle: 'สร้างโปรเจ็กต์',
    projectFolder: 'โฟลเดอร์โปรเจ็กต์',
    selectProjectFolder: 'เลือกโฟลเดอร์',
    changeProjectFolder: 'เปลี่ยนโฟลเดอร์',
    projectFolderRequired: 'เลือกโฟลเดอร์โปรเจ็กต์เพื่อดำเนินการต่อ',
    createProjectFailed: 'ไม่สามารถสร้างโปรเจ็กต์ได้',
  ...
  id: {
    ...
    selectProjectFolder: 'Pilih folder',
    changeProjectFolder: 'Ubah folder',
    projectFolderRequired: 'Pilih folder proyek untuk melanjutkan.',
    createProjectFailed: 'Tidak dapat membuat proyek.',
  ...
  ru: {
    ...
    selectProjectFolder: 'Выбрать папку',
    changeProjectFolder: 'Изменить папку',
    projectFolderRequired: 'Выберите папку проекта, чтобы продолжить.',
  ...
  ar: {
    ...
    selectProjectFolder: 'اختيار مجلد',
    changeProjectFolder: 'تغيير المجلد',
    projectFolderRequired: 'اختر مجلد المشروع للمتابعة.',
    createProjectFailed: 'تعذر إنشاء المشروع.',
  ...
  pt: {
    ...
    selectProjectFolder: 'Selecionar pasta',
    changeProjectFolder: 'Alterar pasta',
    projectFolderRequired: 'Selecione uma pasta de projeto para continuar.',
    createProjectFailed: 'Não foi possível criar o projeto.',
  ...
  it: {
    ...
    createProjectTitle: 'Crea progetto',
    projectFolder: 'Cartella del progetto',
    selectProjectFolder: 'Seleziona cartella',
    changeProjectFolder: 'Cambia cartella',
    projectFolderRequired: 'Seleziona una cartella del progetto per continuare.',
    createProjectFailed: 'Impossibile creare il progetto.',
  ...
  pl: {
    ...
    selectProjectFolder: 'Wybierz folder',
    changeProjectFolder: 'Zmień folder',
    projectFolderRequired: 'Wybierz folder projektu, aby kontynuować.',
    createProjectFailed: 'Nie można utworzyć projektu.',
  ...
  nl: {
    ...
    createProjectTitle: 'Project maken',
    projectFolder: 'Projectmap',
    selectProjectFolder: 'Map selecteren',
    changeProjectFolder: 'Map wijzigen',
    projectFolderRequired: 'Selecteer een projectmap om door te gaan.',
    createProjectFailed: 'Project kon niet worden gemaakt.',
  ...
  ms: {
    ...
    createProjectTitle: 'Cipta projek',
    projectFolder: 'Folder projek',
    selectProjectFolder: 'Pilih folder',
    changeProjectFolder: 'Tukar folder',
    projectFolderRequired: 'Pilih folder projek untuk meneruskan.',
    createProjectFailed: 'Tidak dapat mencipta projek.',
  ...
  he: {
    ...
    createProjectTitle: 'יצירת פרויקט',
    projectFolder: 'תיקיית הפרויקט',
    selectProjectFolder: 'בחירת תיקייה',
    changeProjectFolder: 'שינוי תיקייה',
    projectFolderRequired: 'יש לבחור תיקיית פרויקט כדי להמשיך.',
    createProjectFailed: 'לא ניתן ליצור את הפרויקט.',
  ...
  hi: {
    ...
    createProjectTitle: 'प्रोजेक्ट बनाएँ',
    projectFolder: 'प्रोजेक्ट फ़ोल्डर',
    selectProjectFolder: 'फ़ोल्डर चुनें',
    changeProjectFolder: 'फ़ोल्डर बदलें',
    projectFolderRequired: 'जारी रखने के लिए प्रोजेक्ट फ़ोल्डर चुनें।',
    createProjectFailed: 'प्रोजेक्ट नहीं बनाया जा सका।',
  ...
  'zh-TW': {
    ...
    projectFolder: '專案資料夾',
    selectProjectFolder: '選擇資料夾',
    changeProjectFolder: '變更資料夾',
    projectFolderRequired: '請選擇專案資料夾以繼續。',
    createProjectFailed: '無法建立專案。',
    deleteProject: '刪除專案…',
